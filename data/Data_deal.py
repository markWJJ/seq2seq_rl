...
class DataDealSeq(object):
    ...
    def get_vocab(self):
        ...
        for ele in train_file:
            ...
            try:
                ...
                print(ele)
            for t in ''.join(title.split(" ")):

                if t and t not in content_vocab:
                    content_vocab[t]=content_index
                    content_index+=1

            for c in ''.join(content.split(" ")):
    ...
    def get_train_data(self):
        ...
        result_content_input, result_content_decoder, result_content_len_list, result_title, result_title_len_list, result_loss_weight = \
            self.shuffle(result_content_input, result_content_decoder, result_content_len_list, result_title,
                         result_title_len_list, result_loss_weight)

        split_num=int(0.9*(len(result_content_input)))
        train_result_content_input,test_result_content_input=result_content_input[:split_num],result_content_input[split_num::]
        train_result_content_decoder,test_result_content_decoder=result_content_decoder[:split_num],result_content_decoder[split_num::]
        train_result_content_len_list,test_result_content_len_list=result_content_len_list[:split_num],result_content_len_list[split_num::]
        train_result_title,test_result_title=result_title[:split_num],result_title[split_num::]
        train_result_title_len_list,test_result_title_len_list=result_title_len_list[:split_num],result_title_len_list[split_num::]
        train_result_loss_weight,test_result_loss_weight=result_loss_weight[:split_num],result_loss_weight[split_num::]
        train_data=(train_result_content_input,train_result_content_decoder,train_result_content_len_list,train_result_title,train_result_title_len_list,_)
        test_data=(test_result_content_input,test_result_content_decoder,test_result_content_len_list,test_result_title,test_result_title_len_list,_)
    ...
    def get_sent(self,sent):
        ...
        sents_title=' '.join([e for e in sent])
...
if __name__ == '__main__':
    ...
    dd = DataDealSeq(train_path="/train_sample.txt", test_path="/test.txt",
                            dev_path="/test.txt",
                            dim=100, batch_size=16 ,content_len=15, title_len=15, flag="train_new")



    # train_data,test_data=dd.get_train_data()
    # train_result_content_input, train_result_content_decoder, train_result_content_len_list, train_result_title, train_result_title_len_list,_=train_data
    #
    # print(train_result_content_input[0])
    # print(train_result_content_len_list[0])
    #
    # print(train_result_content_decoder[0])
    # #
    # # print(train_result_title[0])
    # print(dd.content_vocab)
    # print(dd.title_vocab['我'])

    sent='今天天气怎么样'

    result_content_input, result_content_decoder, result_title, result_content_len_list, result_title_len_list, _=dd.get_sent(sent)

    print(result_content_len_list)
